-- nvim --headless -c "luafile /full/path/to/myscript.lua" -c "qa"

-- [[
-- Read from ~/.local/share/nvim/site/pack/core/opt/nvim-treesitter/lua/nvim-treesitter/parsers.lua
-- (vim.pack install path on Neovim 0.12) and convert the output to a json file for python.
-- ]]

local function table_to_json(tbl, filename)
...
table_to_json(list, "parsers.json")
